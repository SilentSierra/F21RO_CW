    ...
    def sense_compute_and_actuate(self):
        ...
        if(len(self.inputs) > 0 and len(self.inputsPrevious) > 0):
            ...
            if(np.max(self.inputs[3:11]) > 0.4):
                ...
                self.velocity_left = -10;
                self.velocity_right = 10;
            # Turn
            if(self.flag_turn):
                self.velocity_left = -0.9;
                self.velocity_right = 0.9;
    ...
    def run_robot(self):        
        ...
        while self.robot.step(self.time_step) != -1:
            ...
            if(center > 500):
                ...
                print("GREY")
                # run a function that'll change a path-finding value
            #print("({} - {} - {}) Object or walls detected!".format(left, center, right))
